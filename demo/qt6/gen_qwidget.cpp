...
#include <qpainter.h>
#include <qpalette.h>
#define WORKAROUND_INNER_CLASS_DEFINITION_QPalette__ColorRole
#include <qpixmap.h>
#include <qpoint.h>
#include <qpoint.h>
#include <qrect.h>
...
#define WORKAROUND_INNER_CLASS_DEFINITION_QSizePolicy__Policy
#include <qstring.h>
#include <qbytearray.h>
#include <cstring>
#include <qstyle.h>
...
QVariant* miqt_exec_callback_QWidget_inputMethodQuery(const QWidget*, intptr_t, Qt::InputMethodQuery);
...
public:
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		Qt::InputMethodQuery sigval1 = param1;
		QVariant* callback_return_value = miqt_exec_callback_QWidget_inputMethodQuery(this, handle__inputMethodQuery, sigval1);
		return *callback_return_value;
	}

	friend QVariant* QWidget_virtualbase_inputMethodQuery(const void* self, Qt::InputMethodQuery param1);
	...
	friend void QWidget_protectedbase_updateMicroFocusWithQuery(bool* _dynamic_cast_ok, void* self, Qt::InputMethodQuery query);
	friend void QWidget_protectedbase_createWithWId(bool* _dynamic_cast_ok, void* self, WId param1);
	friend void QWidget_protectedbase_create2(bool* _dynamic_cast_ok, void* self, WId param1, bool initializeWindow);
	friend void QWidget_protectedbase_create3(bool* _dynamic_cast_ok, void* self, WId param1, bool initializeWindow, bool destroyOldWindow);
...
QWidget* QWidget_new3(QWidget* parent, Qt::WindowFlags f) {
	return new (std::nothrow) MiqtVirtualQWidget(parent, f);
}
...
WId QWidget_winId(const QWidget* self) {
	return self->winId();
}
...
WId QWidget_internalWinId(const QWidget* self) {
	return self->internalWinId();
}

WId QWidget_effectiveWinId(const QWidget* self) {
...
Qt::WindowModality QWidget_windowModality(const QWidget* self) {
	return self->windowModality();
}

void QWidget_setWindowModality(QWidget* self, Qt::WindowModality windowModality) {
...
void QWidget_setBackgroundRole(QWidget* self, QPalette__ColorRole* backgroundRole) {
	self->setBackgroundRole(*backgroundRole);
}

QPalette__ColorRole* QWidget_backgroundRole(const QWidget* self) {
	return new QPalette::ColorRole(self->backgroundRole());
}

void QWidget_setForegroundRole(QWidget* self, QPalette__ColorRole* foregroundRole) {
	self->setForegroundRole(*foregroundRole);
}

QPalette__ColorRole* QWidget_foregroundRole(const QWidget* self) {
	return new QPalette::ColorRole(self->foregroundRole());
}
...
void QWidget_grabGesture(QWidget* self, Qt::GestureType type) {
	self->grabGesture(type);
}

void QWidget_ungrabGesture(QWidget* self, Qt::GestureType type) {
...
void QWidget_setLayoutDirection(QWidget* self, Qt::LayoutDirection direction) {
	self->setLayoutDirection(direction);
}

Qt::LayoutDirection QWidget_layoutDirection(const QWidget* self) {
...
void QWidget_setFocusWithReason(QWidget* self, Qt::FocusReason reason) {
	self->setFocus(reason);
}

Qt::FocusPolicy QWidget_focusPolicy(const QWidget* self) {
	return self->focusPolicy();
}

void QWidget_setFocusPolicy(QWidget* self, Qt::FocusPolicy policy) {
...
Qt::ContextMenuPolicy QWidget_contextMenuPolicy(const QWidget* self) {
	return self->contextMenuPolicy();
}

void QWidget_setContextMenuPolicy(QWidget* self, Qt::ContextMenuPolicy policy) {
...
Qt::WindowStates QWidget_windowState(const QWidget* self) {
	return self->windowState();
}

void QWidget_setWindowState(QWidget* self, Qt::WindowStates state) {
	self->setWindowState(state);
}

void QWidget_overrideWindowState(QWidget* self, Qt::WindowStates state) {
	self->overrideWindowState(state);
}
...
void QWidget_setSizePolicy2(QWidget* self, QSizePolicy__Policy* horizontal, QSizePolicy__Policy* vertical) {
...
void QWidget_setParent2(QWidget* self, QWidget* parent, Qt::WindowFlags f) {
...
void QWidget_setWindowFlags(QWidget* self, Qt::WindowFlags type) {
	self->setWindowFlags(type);
}

Qt::WindowFlags QWidget_windowFlags(const QWidget* self) {
	return self->windowFlags();
}

void QWidget_setWindowFlag(QWidget* self, Qt::WindowType param1) {
	self->setWindowFlag(param1);
}

void QWidget_overrideWindowFlags(QWidget* self, Qt::WindowFlags type) {
	self->overrideWindowFlags(type);
}

Qt::WindowType QWidget_windowType(const QWidget* self) {
	return self->windowType();
}

QWidget* QWidget_find(WId param1) {
...
void QWidget_setAttribute(QWidget* self, Qt::WidgetAttribute param1) {
	self->setAttribute(param1);
}

bool QWidget_testAttribute(const QWidget* self, Qt::WidgetAttribute param1) {
	return self->testAttribute(param1);
}
...
QVariant* QWidget_inputMethodQuery(const QWidget* self, Qt::InputMethodQuery param1) {
	return new QVariant(self->inputMethodQuery(param1));
}

Qt::InputMethodHints QWidget_inputMethodHints(const QWidget* self) {
	return self->inputMethodHints();
}

void QWidget_setInputMethodHints(QWidget* self, Qt::InputMethodHints hints) {
...
void QWidget_grabGesture2(QWidget* self, Qt::GestureType type, Qt::GestureFlags flags) {
	self->grabGesture(type, flags);
}

int QWidget_grabShortcut2(QWidget* self, QKeySequence* key, Qt::ShortcutContext context) {
	return self->grabShortcut(*key, context);
}
...
void QWidget_setWindowFlag2(QWidget* self, Qt::WindowType param1, bool on) {
	self->setWindowFlag(param1, on);
}

void QWidget_setAttribute2(QWidget* self, Qt::WidgetAttribute param1, bool on) {
	self->setAttribute(param1, on);
}
...
QWidget* QWidget_createWindowContainer3(QWindow* window, QWidget* parent, Qt::WindowFlags flags) {
...
QVariant* QWidget_virtualbase_inputMethodQuery(const void* self, Qt::InputMethodQuery param1) {
	return new QVariant(static_cast<const MiqtVirtualQWidget*>(self)->QWidget::inputMethodQuery(param1));
}
...
void QWidget_protectedbase_updateMicroFocusWithQuery(bool* _dynamic_cast_ok, void* self, Qt::InputMethodQuery query) {
	MiqtVirtualQWidget* self_cast = static_cast<MiqtVirtualQWidget*>( (QWidget*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
	...
	*_dynamic_cast_ok = true;
	self_cast->updateMicroFocus(query);
}

void QWidget_protectedbase_createWithWId(bool* _dynamic_cast_ok, void* self, WId param1) {
	MiqtVirtualQWidget* self_cast = static_cast<MiqtVirtualQWidget*>( (QWidget*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
	...
	*_dynamic_cast_ok = true;
	self_cast->create(param1);
}

void QWidget_protectedbase_create2(bool* _dynamic_cast_ok, void* self, WId param1, bool initializeWindow) {
	MiqtVirtualQWidget* self_cast = static_cast<MiqtVirtualQWidget*>( (QWidget*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
	...
	*_dynamic_cast_ok = true;
	self_cast->create(param1, initializeWindow);
}

void QWidget_protectedbase_create3(bool* _dynamic_cast_ok, void* self, WId param1, bool initializeWindow, bool destroyOldWindow) {
	MiqtVirtualQWidget* self_cast = static_cast<MiqtVirtualQWidget*>( (QWidget*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
	...
	*_dynamic_cast_ok = true;
	self_cast->create(param1, initializeWindow, destroyOldWindow);
}
