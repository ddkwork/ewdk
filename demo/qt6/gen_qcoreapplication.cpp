...
#include <qevent.h>
#define WORKAROUND_INNER_CLASS_DEFINITION_QEventLoop__ProcessEventsFlags
#include <qlist.h>
...
void QCoreApplication_setAttribute(Qt::ApplicationAttribute attribute) {
...
void QCoreApplication_processEvents2(QEventLoop__ProcessEventsFlags* flags, int maxtime) {
	QCoreApplication::processEvents(*flags, static_cast<int>(maxtime));
}

void QCoreApplication_processEvents3(QEventLoop__ProcessEventsFlags* flags, QDeadlineTimer* deadline) {
...
Qt::PermissionStatus QCoreApplication_checkPermission(QCoreApplication* self, QPermission* permission) {
...
void QCoreApplication_setAttribute2(Qt::ApplicationAttribute attribute, bool on) {
	QCoreApplication::setAttribute(attribute, on);
}

void QCoreApplication_processEventsWithFlags(QEventLoop__ProcessEventsFlags* flags) {
